...
<html>
    <head>
         <meta charset="utf-8">
        <meta name="description" content="طريقة اتصال الشبكات ببعضها">
        <title> ربط شبكات </title>
    ...
    <body>
        ...
        <!-- start subject -->
        <div class="container">
            <div class="subject"> Connecting </div>
            <table>
                <tr>
                    <th> مذكرات </th>
                    <th> كتاب </th>
                ...
                <tr>
                    <td>
                        <ul>
                            <li><a href="https://drive.google.com/file/d/1CRxkqFttkb-mpm_ixjvxkA3tFUct2syD/view?usp=sharing"> ملزمة 1 </a> </li>
                        </ul>
                    </td>
                    <td>
                        <ul>
